 ...
 */
  ...
  if (!$copy) {
    ...
    header("Location: ../member_circ/mbr_view.php?mbrid=".U($mbrid));
    exit();
    ...
    header("Location: ../member_circ/mbr_view.php?mbrid=".U($mbrid));
    exit();
  } else if ($copy->getStatusCd() != OBIB_STATUS_OUT && $copy->getStatusCd() != OBIB_STATUS_MENDING && $copy->getStatusCd() != OBIB_STATUS_LOST && $copy->getStatusCd() != OBIB_STATUS_ON_HOLD) {
  ...
  #**************************************************************************
  header("Location: ../member_circ/mbr_view.php?mbrid=".U($_POST["mbrid"]));
?>
