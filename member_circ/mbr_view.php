...
<h1><?php echo $loc->getText("mbrViewHead4"); ?>
  <font class="primary">
  <a href="javascript:popSecondary('../member_circ/mbr_print_checkouts.php?mbrid=<?php echo H(addslashes(U($mbrid)));?>')">[<?php echo $loc->getText("mbrPrintCheckouts"); ?>]</a>
  </font>
</h1>
<table class="primary">
  <tr>
...
?>
  <tr>
    ...
    <td class="primary" valign="top" >
      <?php
		if($biblio->getRenewalCount()<2){?>
		 <a href="../member_circ/checkout.php?barcodeNmbr=<?php echo HURL($biblio->getBarcodeNmbr());?>&amp;mbrid=<?php echo HURL($mbrid);?>&amp;renewal">Renew item</A>
	   <?php
		}?>
	  
	  <?php
		if($biblio->getRenewalCount() > 0) { ?>
         <?php if($biblio->getRenewalCount()<2){?> </br> <?php } ?>
...
<!--****************************************************************************
    *  Hold form
    **************************************************************************** -->
<form name="holdForm" method="POST" action="../member_circ/place_hold.php">
<table class="primary">
  <tr>
    <th valign="top" nowrap="yes" align="left">
...
?>
  <tr>
    <td class="primary" valign="top" nowrap="yes">
      <a href="../member_circ/hold_del_confirm.php?bibid=<?php echo HURL($hold->getBibid());?>&amp;copyid=<?php echo HURL($hold->getCopyid());?>&amp;holdid=<?php echo HURL($hold->getHoldid());?>&amp;mbrid=<?php echo HURL($mbrid);?>"><?php echo $loc->getText("mbrViewDel"); ?></a>
    </td>
    <td class="primary" valign="top" nowrap="yes">
