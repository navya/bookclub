...
?>
  <tr>
    ...
    <td class="primary" valign="top" >
     <form name="barcodesearch<?php echo HURL($biblio->getBarcodeNmbr());?>" method="POST" action="../circ/shelving_cart.php">
       <input type="hidden" name="barcodeNmbr" value="<?php echo $biblio->getBarcodeNmbr()?>">
       <input type="submit" value="<?php echo $loc->getText("checkinFormShelveButtonc"); ?>" class="button">
      </form>
    </td>
    <td class="primary" valign="top" >
