 ...
 */
  ...
  $nav = "view";
  if ($tab != "opac" && $tab != "member_circulation") {
  ...
  } else if($tab == "member_circulation") {
...
<table class="primary">
  <tr>
    ...
    <th align="left" nowrap="yes">
      <?php echo $loc->getText("biblioViewTble2ColHold"); ?>
    </th>
    <th align="left" nowrap="yes">
  ...
  ?>
    <tr>
      ...
      <td valign="top" class="<?php echo H($row_class);?>">
        <?php 
	 if($copy->getStatusCd() == OBIB_STATUS_OUT || $copy->getStatusCd() == OBIB_STATUS_ON_HOLD) echo '<a href="anon_hold.php?bibid='.$copy->getBibid().'&copyid='.$copy->getCopyid().'&tab='.$tab.'"> put</a>'; else echo H("available"); ?>
      </td>
      <td valign="top" class="<?php echo H($row_class);?>">
...
<table class="primary">
  ...
  <?php
      ...
      <?php if ($tab == "cataloging") { ?>	
<form name="isbninput" action="../catalog/update_isbn.php" method="get">
New Isbn: <input type="text" name="newisbn" autofocus><br>
