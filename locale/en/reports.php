...
#*  Report Titles
#****************************************************************************
$trans["biblioDuplicates"]         = "\$text = 'Duplicate Titles';";
$trans["biblioDuplicatesDetailed"] = "\$text = 'Duplicate Titles Detailed';";
$trans["holds"]                    = "\$text = 'Hold Requests ';";
$trans["reportHoldsDetailed"]      = "\$text = 'Hold Requests Containing Member Contact Info ';";
$trans["checkouts"]                = "\$text = 'Bibliography Checkout Listing';";
$trans["checkoutsEmail"]           = "\$text = 'Bibliography Checkout Listing with Member Emails';";
$trans["checkoutStats"]            = "\$text = 'Periodic Checkout Count';";
$trans["checkoutStatsCollection"]  = "\$text = 'Periodic Checkout Count with Collections';";
$trans["checkoutsDetailed"]        = "\$text = 'Bibliography Checkout Listing Detailed';";
...
$trans["overdueListEmail"]         = "\$text = 'Over Due Member List with Member Emails';";
$trans["overdueListDetailed"]      = "\$text = 'Over Due Member List Detailed';";
$trans["balanceDueList"]           = "\$text = 'Balance Due Member List';"; 
$trans["balanceDueListEmail"]      = "\$text = 'Balance Due Member List with Member Emails';"; 
$trans["balanceDueListDetailed"]   = "\$text = 'Balance Due Member List Detailed';"; 
$trans["members"]                  = "\$text = 'Member Search';";
$trans["membersDetailed"]          = "\$text = 'Member Search Detailed';";
$trans["membersComment"]           = "\$text = 'Members with Comment';";
$trans["popularAuthors"]           = "\$text = 'Most Popular Authors';";
$trans["itemHistory"]              = "\$text = 'Item Checkout History';";
$trans["copies"]                   = "\$text = 'Copy Search';";
$trans["copiesDetailed"]                   = "\$text = 'Copy Search Detailed';";
$trans["copiesComment"]            = "\$text = 'Copies with Comment/Changes';";
$trans["books"]                    = "\$text = 'Books';";
