 ...
 */
  ...
  if (isset($_GET["bibid"])){
    ...
    $postVars["lastMailDt"] = $copy->getLastMailDt();
...
?>
  ...
  <tr>
    <td nowrap="true" class="primary" valign="top">
      <?php echo $loc->getText("biblioCopyLastMaildt"); ?>:
    </td>
    <td valign="top" class="primary">
      <?php printInputText("lastMailDt",10,10,$postVars,$pageErrors); ?>
      <input type="checkbox" name="iftoday" />
      <?php echo $loc->getText("biblioCopyLastMaildtToday"); ?>
    </td>
  </tr>
  <tr>
